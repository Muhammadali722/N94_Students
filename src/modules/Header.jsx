          ...
          >
            <div className="w-[30px] h-[30px] transition-transform duration-500 group-hover:scale-125">
              <div className="w-full h-full">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" className="transition-transform duration-300 transform group-hover:translate-x-10 group-hover:scale-110 group-hover:fill-white"
                >
